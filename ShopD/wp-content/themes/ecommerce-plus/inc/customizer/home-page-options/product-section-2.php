...
$wp_customize->add_section( 'ecommerce_plus_product_section_2', array(
	...
	'description'       => esc_html__( 'Product Section 2,If this content not displayed, First create a page from home-page-template and set as home page. Then open customizer.', 'ecommerce-plus' ),
