...
if (!function_exists('ecommerce_plus_cart_link')) {
	...
	?>
		<a class="cart-contents" href="<?php echo esc_url(wc_get_cart_url()); ?>" data-tooltip="<?php esc_attr_e('Cart', 'ecommerce-plus'); ?>" title="<?php esc_attr_e('Cart', 'ecommerce-plus'); ?>">
			<i class="fa fa-shopping-bag"><span class="count"><?php if (WC()->cart) {
																	echo wp_kses_data(WC()->cart->get_cart_contents_count());
																} ?></span></i>
			<div class="amount-cart hidden-xs"><?php if (WC()->cart) {
...
function ecommerce_plus_site_navigation()
{
	...
	$options  = ecommerce_plus_get_theme_options();
?>
	<div id="site-menu " class="menu-from-serach">

		<div class="woo-product-search-form text-center">
...
function ecommerce_plus_topbar_content()
{
	...
	if (
		$options['contact_section_phone'] == '' && $options['contact_section_email'] == '' && $options['contact_section_address'] == '' && $options['contact_section_hours'] == '' &&
		$options['social_whatsapp_link'] == '' && $options['social_instagram_link'] == '' && $options['social_youtube_link'] == '' && $options['social_linkdin_link'] == ''
		&& $options['social_twitter_link'] == '' && $options['social_facebook_link'] == ''
	) return;
...
function ecommerce_plus_general_admin_notice()
{
	...
	$msg = sprintf(
		'<div data-dismissible="disable-done-notice-forever" class="notice notice-info" >
		 		<h3>%1$s</h3>
				<p>%2$s</p><p>
